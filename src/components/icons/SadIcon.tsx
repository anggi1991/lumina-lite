...
export function SadIcon({ theme = 'light', size = 24, color, accentColor }: IconProps) {
  ...
  return (
    <Svg width={size} height={size} viewBox="20 20 80 80" fill="none">
      ...
      <Path d="M 48 70 Q 60 62 72 70" stroke={accent} strokeWidth="2.5" strokeLinecap="round" fill="none" />
    </Svg>
  );
}
