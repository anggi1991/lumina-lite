...
export function StressedIcon({ theme = 'light', size = 24, color, accentColor }: IconProps) {
  ...
  return (
    <Svg width={size} height={size} viewBox="20 20 80 80" fill="none">
      ...
      <Path d="M 48 66 Q 52 68 56 66 Q 60 64 64 66 Q 68 68 72 66" stroke={accent} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
    </Svg>
  );
}
